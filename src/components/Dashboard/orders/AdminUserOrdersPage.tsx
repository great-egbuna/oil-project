      ...
      <div className="space-y-4">
        {(activeTab === "pending" ? pendingOrders : confirmedOrders).map(
          (order) => (
            <div
              key={order.id}
              className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-primary-red/50 hover:shadow-md transition-shadow"
            >
              <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-3">
                ...
                {activeTab === "pending" && (
                  <div className="flex flex-col xs:flex-row md:flex-col lg:flex-row gap-2">
                    <button
